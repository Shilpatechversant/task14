...
nameconflict="overwrite">
  ...
  <cfquery datasource="newtech">
            INSERT INTO sakila.image_table(NAME,DESCP,PICTURE) VALUES ('#form.name#','#form.description#','#fileupload.serverfile#')
        </cfquery>
...
<cfquery name="img_data" datasource="newtech">
 SELECT *
...
<td><a href='list.cfm?img_id=#id#'><cfimage source="#thumbail_path#" action="writeToBrowser"></a>
</td></tr>
</cfoutput>
</table>
